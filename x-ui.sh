...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/Sora39831/X-Panel/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update_menu() {
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/Sora39831/X-Panel/main/x-ui.sh
...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/Sora39831/X-Panel/master/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/Sora39831/X-Panel/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/Sora39831/X-Panel/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
...
bash <(curl -Ls https://raw.githubusercontent.com/Sora39831/sublink/main/install.sh)
...
——————————————————————
  ...
  ${yellow}https://github.com/Sora39831/X-Panel${plain}
